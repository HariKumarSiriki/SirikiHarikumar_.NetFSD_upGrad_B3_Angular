...
namespace Contact_Service.Controllers
{
    ...
    public class ContactsController : ControllerBase
    {
        ...
        [HttpPost] public async Task<IActionResult> Post(Contact c)
        { 
            await _service.CreateContact(c);
            return Ok();
        }
        [HttpPut] public async Task<IActionResult> Put(Contact c)
        { 
            await _service.UpdateContact(c); 
            return Ok();
        }
